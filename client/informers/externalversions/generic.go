...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta1.SchemeGroupVersion.WithResource("backupvolumecontents"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kahu().V1beta1().BackupVolumeContents().Informer()}, nil
